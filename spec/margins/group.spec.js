var LoginPage = pageRequire('login'),
    GroupPage = pageRequire('margins/group'),
...
describe('Margins Group Create Page', function() {
    var driver,
        login,
        page,
        groupsPage,
    ...
    it('Page Subtitle should be \'Edit flight margins group\'', function(done) {
        page
            .getSubTitle()
            .then(function(title) {
                expect(title.toLowerCase()).toContain(i18n('flightMarginsGroup'));
            })
            .then(done);
    }, 10000);
